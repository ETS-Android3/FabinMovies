...
public class RecyclerViewTopRatedAdapter extends RecyclerView.Adapter<RecyclerViewTopRatedAdapter.ViewHolder>
    ...
    public RecyclerViewTopRatedAdapter(Context context, RecyclerViewInterface recyclerViewInterface) {
    ...
    public Filter getFilter() {
        ...
        if (mFilter == null){
            ...
            mFilter = new TopRatedFilter(RecyclerViewTopRatedAdapter.this, this.mFilteredMoviesList);
        }
        return mFilter;
    ...
    @NonNull
    @Override
    public RecyclerViewTopRatedAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        View view = LayoutInflater.from(context).inflate(R.layout.item_movie, parent, false);
        return new RecyclerViewTopRatedAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull RecyclerViewTopRatedAdapter.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
